<template>
  <!-- <Button
    :label="label"
    class="mx-h-[42px] whitespace-nowrap"
    :class="[
      outline
        ? 'bg-transparent border-solid border-[1px] border-[var(--primary-color)] text-[var(--primary-color)] '
        : flat
        ? 'bg-transparent border-none  text-[#808693]'
  ...
  <button
    :type="type"
    @click="emits('click')"
    class="mx-h-[42px] whitespace-nowrap px-5 py-2 rounded-md font-medium hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-20"
    :class="[
      outline
        ? 'bg-transparent border-solid border-[1px] border-[var(--primary-color)] text-[var(--primary-color)] '
        : flat
